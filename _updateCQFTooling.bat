...
SET "dlurl=https://oss.sonatype.org/service/local/artifact/maven/redirect?r=snapshots&g=org.opencds.cqf&a=tooling-cli&v=3.1.0"
SET tooling_jar=tooling-cli-3.1.0.jar
